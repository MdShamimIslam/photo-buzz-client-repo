    ...
    <div className="pt-36 bg-gray-800 ">
      <div className="justify-center flex">
        <div className="card object-fill w-3/5 bg-base-100 shadow-xl">
          <figure>
            <img src={imgage} alt="reviewimage" />
          </figure>
          <div className="card-body pt-2">
            <div className="flex  justify-between ">
              <p> Package : {price}</p>
              <p className="flex ">
                <FaStar className="text-yellow-300 mt-[2px] mr-2"></FaStar>{" "}
      ...
      <div className="flex justify-evenly">
        <div className="w-1/3 mt-12">
          {user?.uid ? (
            <>
              <form
                onSubmit={handleForm}
                className=" border-2 border-emerald-500 p-3 rounded-xl mt-6 px-18"
              >
                <div>
                  <h1 className="text-md text-gray-100 ">
                    Rate and review purchased Service
                  </h1>
                </div>
                <div className="form-control">
                  ...
                  <input
                    ...
                    name="rating"
                    placeholder="Rating"
                    className="input bg-gray-200 input-bordered rounded-md"
                  />
                </div>
                <div className="form-control">
                  <label className="label">
                  ...
                  <textarea
                    className="textarea textarea-info rounded-md bg-gray-200 "
                    name="review"
                    placeholder="Please ahare our feedback about this service ?  was the service as describe"
                  ></textarea>
                </div>
            ...
            <>
              <div className="text-center border-2  py-10 text-white text-2xl">
                ...
                <button
                  ...
                  className="btn btn-outline border-2 mt-2 w-24 border-red-500 rounded-md text-white"
                >
                  Login
                </button>
              </div>
        ...
        <div className="w-2/4 my-4 ">
          ...
          {reviews.length < 1 ? (
            <p className="text-xl text-center border-2 text-white w-full">
              {" "}
              Empty Review
            </p>
          ) : (
            reviews.map((review) => (
              <PublicReview key={review._id} reviewss={review}></PublicReview>
            ))
          )}
        </div>
      </div>
