...
const AddService = () => {
  ...
  useEffect(() => {
    fetch(`https://photo-buzz-server.vercel.app/services`)
      .then((res) => res.json())
  ...
  return (
    <div className="py-40 px-20">
      <form
        onSubmit={handleForm}
        className=" border-2 border-emerald-500 p-3 rounded-xl mt-8"
      >
        <div>
          <h1 className="text-4xl text-center  border-double border-emerald-200 ">
