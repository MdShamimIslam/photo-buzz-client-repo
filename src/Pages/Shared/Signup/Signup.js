...
const SignUp = () => {
  ...
  const { createUser, profileUpdate, googleSignin, loading, setLoading } =
  ...
  return (
    <div>
      ...
      <div
        className="hero pt-24 min-h-screen 
       bg-base-200"
      >
            ...
            <div className="card-body">
              <form onSubmit={handleForm}>
                ...
                <div className="flex justify-between">
                  <div to="#" className=" link link-hover">
                    <small>Alreday you have Account?</small>{" "}
              ...
              <div
                ...
                className="flex justify-center bg-gray-500 rounded-md space-x-4"
              >
                <button
