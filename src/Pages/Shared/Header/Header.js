      ...
      <div className=" fixed top-0 z-30 w-full px-2 py-4   sm:px-4 shadow-2xl navbar  text-white text-xl bg-gray-700">
        <div className="navbar-start px-5">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-compact dropdown-content bg-gray-400 mt-3 pt-2 shadow  rounded-box w-96 "
            >
              <li>
                <Link to="/">Home</Link>
              </li>
              ...
              {user?.uid && user?.email ? (
                <>
                  ...
                  <li className="mt-3 cursor-pointer" onClick={handleSignout}>
                    Logout
                  </li>
                </>
              ) : (
          ...
          <Link to="/" className="btn btn-ghost normal-case text-xl">
            ...
            <h3 className="text-3xl">PhotoBuzz</h3>
          </Link>
        </div>
